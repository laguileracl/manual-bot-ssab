...
::: {.column-page-inset}
![*Búsqueda de cliente por nombre*](assets/04-busqueda-nombre.png){width=70% fig-align="center"}
:::
...
::: {.column-page-inset}
![*Información detallada del cliente*](assets/05-ficha-cliente.png){width=70% fig-align="center"}
:::
