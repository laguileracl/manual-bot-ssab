...
::: {.column-page-inset}
![*Menú de análisis de cartera*](assets/08-menu-cxc.png){width=70% fig-align="center"}
:::
...
::: {.column-page-inset}
![*Reporte de facturas vencidas*](assets/09-vencidas.png){width=70% fig-align="center"}
:::
...
::: {.column-page-inset}
![*Facturas próximas a vencer*](assets/10-por-vencer.png){width=70% fig-align="center"}
:::
...
- [ ] He iniciado conversación con [@oxcl_bot](https://t.me/oxcl_bot)
